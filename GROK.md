...
- Intake organization lives only in 00_* folders. Working source (src/, public/, config) stays at root.
...
- Confirm protected items (.grok, 00_*, zips) untouched
