        ...
        <ScrollReveal>
          <div className="mx-auto min-w-0 max-w-prose space-y-6 sm:max-w-2xl lg:max-w-[42rem]">
            ...
            <nav
              ...
              className="k2k-surface flex min-w-0 flex-wrap gap-2 overflow-visible rounded-[1.75rem] p-4 sm:gap-2.5 sm:p-6"
            >
              ...
              {SECTIONS.map((section) => (
                <a
                  key={section.id}
                  href={`#${section.id}`}
                  className="inline-flex min-h-11 max-w-full items-center gap-2 rounded-full border border-[#111] bg-white px-3.5 py-2 text-[0.62rem] font-medium uppercase tracking-[0.12em] text-k2k-navy transition hover:bg-k2k-blue/5 sm:px-4 sm:tracking-[0.14em]"
                >
                  <img
                    src={section.icon}
                    alt=""
            ...
            <div className="space-y-5">
              {SECTIONS.map((section) => (
                <article
                  ...
                  id={section.id}
                  className={cn(
                    "k2k-surface scroll-mt-28 overflow-visible rounded-[1.75rem] p-6 sm:p-8",
                  )}
                >
