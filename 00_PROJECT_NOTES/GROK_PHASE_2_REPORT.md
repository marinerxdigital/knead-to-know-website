...
- Created vercel.json:
  ...
  ```
- Re-ran: npm install (success), npm run build (success; .vercel/output/static + functions/\_\_server.func + config.json with routes).
- Verified:
...
- Git: only 4 files changed; .grok not staged, no dist/.vercel/00\_\*/zips
- Commit: a84cf97
- Push: success
...
- src/routes/\_\_root.tsx, index.tsx, about.tsx (titles, hero, intros)
