...
- Core files updated: business.ts, Header.tsx, Footer.tsx, forms, __root.tsx, about.tsx, index.tsx, site-data, squarespace.
...
- Work completed:
  ...
  - Consolidated prior temp_extract_* folders into 00_TEMP_EXTRACT
  ...
  - Preserved without modification: .grok/, 00_* folders, all zips (in archive), logo (in brand assets)
